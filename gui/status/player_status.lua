...
function showDayZDeathScreen()
	...
	deathText = guiCreateLabel(0,0.8,1,0.2,"¡Has muerto! \nApareceras en 30 segundos.",true)
	...
	local countdown = 30
	setTimer(function() countdown = countdown-1 guiSetText(deathText,"¡Has muerto! \nApareceras en "..countdown.." segundos.") end,1000,29)
end