...
shownInfos["nomag"] = "No queda municion para esta arma"
shownInfos["youconsumed"] = "Has consumido"
shownInfos["needwatersource"] = "Debes estar dentro de un cuerpo de agua"
shownInfos["filledup"] = "Llenaste tu botella"
shownInfos["noradio"] = "No tienes radio"
	
--GAMEPLAY
gameplayVariables["zombieblood"] = 4500 -- Zombie Blood/Health - DEFAULT: 4500
gameplayVariables["loseWire"] = 3000 -- Amount of losing blood when hitting a Wirefence that's not yours - DEFAULT: 1000
...
gameplayVariables["maxzombiesglobal"] = 200 -- Not in use
...
gameplayVariables["spawnselection"] = true -- Allow player to select his spawnpoint - DEFAULT: false
...
gameplayVariables["zombiespawnradius"] = 50 -- If newzombiespawnsystem is set to true, determines the radius where zombies spawn around loot - DEFAULT: 20
gameplayVariables["maxzombiesperloot"] = 1 -- if newzombiespawnsystem is set to true, determines how many zombies should spawn around loot - DEFAULT: 6
